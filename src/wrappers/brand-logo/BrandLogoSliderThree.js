...
const BrandLogoSliderThree = ({ spaceBottomClass, spaceTopClass }) => {
  return (
    <div className={clsx("brand-logo-area new-0", spaceBottomClass, spaceTopClass)} >
      <div className="container-fluid">
        <SectionTitleSeven
          titleText="Proudly Partnered With"
          subtitleText="A brief note on how these partnerships benefit Rezingo users."
