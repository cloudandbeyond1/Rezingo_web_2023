...
import PhysicalGridSingle from "../../components/Program/PhysicalGridSingle";
...
console.log(prods,"prods");
  return (
    <Fragment>
          <div className="image-slider-area" style={{backgroundColor:"#fafafa",marginBottom:"25px"}}>
