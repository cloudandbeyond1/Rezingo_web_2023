...
<p className="slide-img-pos-p2">It’s easy to get started</p>
				...
				<div class="col-lg-3">
					...
					<p class="slide-img-pos-p4" style={{textAlign:"justify"}}>
				...
				<div class="col-lg-3">
					...
					<p class="slide-img-pos-p4" style={{textAlign:"justify"}}>We will send you a <span>welcome packet</span>
...
<p style={{textAlign:"justify"}}>Self-care interventions are tools which support the ability of individuals, families and communities to promote health, prevent disease, maintain health, and cope with illness and disability with or without the support of a health worker.
...
{/* <div className="slider-btn  funfact-btn funfact-btn-violet btn-hover mt-4">
 ...
 Play Video  
          ...
          <p className="mt-1">50 mins</p>
                  ...
                  <div className="row mt-2" style={{textAlign:"justify"}}><p>Get ready to activate and mobilise those muscles with coach Nitheesh Ballal. Keep those dumbbells handy and join these sessions to lift and burn with coach Nitheesh.
                    </p> </div>
                  </div>
                  <div className="col-md-4">
                  <img
          ...
          <p className="mt-1">50 mins</p>
                  ...
                  <div className="row mt-2" ><p style={{textAlign:"justify"}}>Get ready to activate and mobilise those muscles with coach Nitheesh Ballal. Keep those dumbbells handy and join these sessions to lift and burn with coach Nitheesh.
                    </p> </div>
                  </div>
                  <div className="col-md-4">
                  <img
...
<div className="slider-btn  funfact-btn funfact-btn-violet btn-hover mt-4">
  ...
  <h2 className="text-center pt-3 text-bold video-test" style={{marginBottom:"15px"}}>
  ...
  <iframe
    ...
    <div className="iframe1"><a href="/wellness" style={{textDecoration: "underline",justifyContent:"center",display:"flex",marginTop:"15px"}}>READ MORE</a></div>
