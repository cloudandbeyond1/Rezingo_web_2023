...
import programs from "../../data/sport.json";
import { useState } from "react";
import SportGridSingle from "../../components/Program/SportGridSingle";
...
console.log(prods,"prods");
  return (
    <Fragment>
          <div className="image-slider-area" style={{backgroundColor:"#fafafa",marginBottom:"30px"}}>
