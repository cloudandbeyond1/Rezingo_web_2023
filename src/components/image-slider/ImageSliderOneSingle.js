...
const ImageSliderOneSingle = ({ data }) => {
  return (
    <div className="single-image" style={{marginRight:"25px",marginLeft:"10px"}}>
     ...
     <p style={{fontSize: "16px",lineHeight: "1.38",marginBottom: "14px",textAlign:"justify"}}>{data.subtitle}</p>
     <div><a href="/blog" style={{textDecoration: "underline"}}>READ MORE</a></div>
     </div>
    </div>
