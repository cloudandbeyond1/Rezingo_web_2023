...
const HeroSliderPhysicalSingle = ({ data, sliderClass }) => {
  return (
    <div
      ...
      <div className="container">
        ...
        <div className="d-flex" style={{ justifyContent: "space-between", position: "relative" ,zIndex: "2"}} >
                <h2 style={{color:"white",fontSize:"25px"}}>PHYSICAL</h2>
...
HeroSliderPhysicalSingle.propTypes = {
  data: PropTypes.shape({})
};

export default HeroSliderPhysicalSingle;
