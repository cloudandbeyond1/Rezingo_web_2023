...
const HeroSliderHealthSingle = ({ data, sliderClass }) => {
  return (
    <div
        ...
        <div className="row">
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="slider-content-margin slider-animated-1" style={{textAlign:"center"}} >
              <h3 className="animated slider-new" >{data.title}</h3>
...
HeroSliderHealthSingle.propTypes = {
  data: PropTypes.shape({})
};

export default HeroSliderHealthSingle;
