...
<div className="single-image" style={{marginRight:"25px",marginLeft:"25px"}}>
      <Link to={process.env.PUBLIC_URL +"/sport/" + product.id}>
     ...
     <div><Link to={process.env.PUBLIC_URL +"/sport/" + product.id}style={{textDecoration: "revert"}}>View More</Link></div>
     </div>
    </div>
...
export default SportGridSingle;
