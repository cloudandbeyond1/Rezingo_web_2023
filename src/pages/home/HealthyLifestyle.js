        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 col-xs-6 col-lg-6 order-1 order-lg-2">
            ...
            {/* <h3>Ready to Embrace a Healthy Lifestyle?</h3> */}
              <p className="pt-4" style={{marginBottom: "4rem",fontSize: "18px",   lineHeight: "1.75rem",textAlign:"justify"}}>Become a part of the Rezingo community today and embark on your journey to holistic wellness. Remember, the first wealth is health.</p>
              <div id="cta-waitlist-input" class="mb-12" style={{position:" relative"}}>
