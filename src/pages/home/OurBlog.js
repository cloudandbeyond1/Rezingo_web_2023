...
/>
  ...
  <Link className=""  style={{textTransform: "uppercase",color:"#5d2d8d",fontWeight:"500"}}    
>Sep 1, 2023</Link>
...
>The Science Behind Holistic Wellness: A Comprehensive Guide</h3>
    <p className="card-text" style={{marginBottom: "12px",textAlign:"justify"}}>Discover the science and evidence behind holistic wellness and its multiple dimensions. Learn to integrate these practices into your daily life.</p>
    <Link to={process.env.PUBLIC_URL + "/blog"} className="" style={{textTransform: "uppercase",color:"#5d2d8d",fontWeight:"500"}}   
>View Post <i className="pe-7s-angle-right"></i></Link>
  </div>
</div>
</div>
<div className="col-md-4 col-xs-12 mb-4 blogg">
...
>Rezingo's 'Health Score': Rewriting Health Insurance</h3>
    <p className="card-text ourblognew1" style={{textAlign:"justify"}}>Understand the concept of 'Health Score’ introduced by Rezingo, its impact on the healthcare and insurance industry, and what it means for you.</p>
    <Link to={process.env.PUBLIC_URL + "/blog"} className="" style={{textTransform: "uppercase",color:"#5d2d8d",fontWeight:"500"}}   
>View Post <i className="pe-7s-angle-right"></i></Link>
  </div>
</div>
...
/>
  <div className="card-body py-5" style={{height: "350px"}}>
  <Link  style={{textTransform: "uppercase",color:"#5d2d8d",fontWeight:"500"}}>Sep 1, 2023</Link>
    <h3 className="card-title" style={{fontWeight: "600", lineHeight: "34px", paddingBottom: "2px", paddingTop: "10px"}}  
>The Interplay of Wellness and Productivity in the Workplace</h3>
<p className="card-text ourblognew2" style={{textAlign:"justify"}}>Uncover how companies can boost productivity and morale by
