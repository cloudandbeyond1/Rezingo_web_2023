    ...
    const handleRegistration = async (e) => {
      ...
      try {
        ...
        await set(userRef, {
         ...
         // Set user information in the AuthContext


      // Navigate to another page without passing displayName in the URL
      ...
      navigate('/',{ state: { displayName } });
        ...
        console.log('User registered and data pushed to the database:',displayName,userUid);
      } catch (error) {
        // Handle registration or database push errors
    ...
    <div class="login-form-inner">
     ...
     <div class="login-form-group">
        ...
        <input autocomplete="off"  {...register('fullname')}
            className={`form-control ${errors.fullname ? 'is-invalid' : ''}`} value={displayName}
            onChange={(e) => setDisplayName(e.target.value)} type="text" placeholder="Enter Your Surname" id="surname"/>
