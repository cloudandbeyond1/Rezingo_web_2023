...
import ImageSliderTwoSingle from "../../components/image-slider/ImageSliderTwoSingle";
import imageData from "../../data/image-slider/image-sliders-two.json";
const params = {
    effect: "fade",
    fadeEffect: {
      crossFade: true
